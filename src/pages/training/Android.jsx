...
import { Success, Error, AndroidImage } from '../../assets/images/layout'
...
const Android = () => {
  ...
  // Get Data API
  useEffect(() => {
    Axios.get('https://itfest.my.id/api/pelatihan-android').then(res => setData(res.data.data))
  }, [])
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await Axios.post('https://itfest.my.id/api/pelatihan-android', postData, {
        headers: {
  ...
  return (
    <div className='bg-gradient-to-tl flex-col  from-gray-900 via-gray-900 to-gray-700 w-full justify-center min-h-screen flex items-center'>
      <Helmet>
        <meta name="description" content="Pelatihan Android IT FESTIVAL 2022" />
        <meta name="keywords" content="Pelatihan Android" />
        <title>Pelatihan Android</title>
        <link rel="icon" href={Logo} />
      </Helmet>
      <div className="min-h-screen items-center justify-center flex flex-col sm:flex-row">
        <img src={AndroidImage} alt="" className='sm:w-1/2 m-auto' />
        <div className="mb-28 -mt-24 sm:mb-0 sm:-mt-0 text-center sm:px-14">
          <p className="zaptron text-center sm:text-5xl text-4xl mt-4 text-white animate-pulse">Android</p>
          <p className="comfortaa text-xs sm:text-base text-gray-500 text-center px-4 sm:px-10"><i>"Development Android Empowerment in Industry Area"</i></p>
          <p className="mt-10 text-gray-200 comfortaa text-center mb-5">HTM Pelatihan Android : 100k</p>
          <a href="https://drive.google.com/drive/folders/1BjQz2kbXuwOmYXse09VNitBzfa1MQmmS" target="blank" className='py-2 px-10 bg-gray-400 rounded-lg hover:bg-gray-300'>Guide Book</a>
        </div>
      </div>
      {/* <p data-aos="fade-up" data-aos-duration="1000" className='text-white zaptron text-sm sm:text-lg border-b border-gray-200 mt-10 py-2'>Form Pendaftaran Pelatihan Android</p>
      ...
      <div data-aos="fade-up" data-aos-duration="1000" className="py-2 px-12 text-sm sm:text-lg sm:px-24 border-2 border-gray-200 text-center mt-10 text-gray-200 comfortaa rounded-lg">
        <p className='flex justify-center'>Kuota Peserta  <span className='ml-2'><Badge color="warning">45</Badge></span></p>
        ...
        <p className='text-xs sm:text-base pb-3 text-white'>ada pertanyaan? <a target="blank" className='text-blue-500 underline' href="https://wa.me/62895604648328?text=Halo%20kak,%20Saya%20mau%20bertanya%20perihal%20Pelatihan%20Android%20IT%20FESTIVAL%202022">Klik disini untuk menghubungi admin</a></p> */}
      <div className="flex flex-col min-h-screen items-center justify-center">
        <img src={Success} className="w-96" alt="" />
        <p data-aos="fade-up" data-aos-duration="1000" className='text-white zaptron text-sm sm:text-lg text-center px-14 mt-10 py-2'>Kuota telah penuh, Jumpa lagi tahun depan yaa..</p>
      </div>
