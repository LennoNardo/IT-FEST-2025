...
import { Success, Error, WebTraining } from '../../assets/images/layout'
...
const Web = () => {
  ...
  // Get Data API
  useEffect(() => {
    Axios.get('https://itfest.my.id/api/pelatihan-web').then(res => setData(res.data.data))
  }, [])
  ...
  //   try {
  //     const response = await Axios.post('https://itfest.my.id/api/pelatihan-web', postData, {
  //       headers : {
  ...
  return (
    <div className='bg-gradient-to-tl flex-col  from-gray-900 via-gray-900 to-gray-700 w-full justify-center min-h-screen flex items-center'>
      <Helmet>
        <meta name="description" content="Pelatihan Web Desain" />
        <meta name="keywords" content="Pelatihan Web Desain" />
        <title>Pelatihan Web Development</title>
        <link rel="icon" href={Logo} />
      </Helmet>
      <div className="min-h-screen items-center justify-center flex flex-col sm:flex-row">
        <img src={WebTraining} alt="" className='sm:w-1/2 m-auto' />
        <div className="mb-28 -mt-24 sm:mb-0 sm:-mt-0 text-center sm:px-14">
          <p className="zaptron text-center sm:text-5xl text-4xl mt-4 text-white animate-pulse">Web Development</p>
          <p className="comfortaa text-xs sm:text-base text-gray-500 text-center px-4 sm:px-10"><i>"Build Creative Website With Creative Mindset"</i></p>
          <p className="mt-10 text-gray-200 comfortaa text-center mb-5">HTM Pelatihan Web Development : 100k</p>
          <a href="https://drive.google.com/drive/folders/1pMA0nOPl9B7tk8XvKDzzPwYSwjOMnf8e" target="blank" className='py-2 px-10 bg-gray-400 rounded-lg hover:bg-gray-300'>Guide Book</a>
        </div>
      </div>
      {/* <p data-aos="fade-up" data-aos-duration="1000" className='text-white zaptron text-sm sm:text-lg border-b border-gray-200 mt-10 py-2'>Form Pendaftaran Pelatihan Web Design</p>
      ...
      <div data-aos="fade-up" data-aos-duration="1000" className="py-2 px-12 text-sm sm:text-lg sm:px-24 border-2 border-gray-200 text-center mt-10 text-gray-200 comfortaa rounded-lg">
        ...
        <p className='text-xs sm:text-base pb-3 text-white'>ada pertanyaan? <a target="blank" className='text-blue-500 underline' href="https://wa.me/6282199599464?text=Halo%20kak,%20Saya%20mau%20bertanya%20perihal%20Pelatihan%20Web%20IT%20FESTIVAL%202022">Klik disini untuk menghubungi admin</a></p> */}
